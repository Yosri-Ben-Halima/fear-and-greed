...
class FuturesData(CryptoMarketData):
    ...
    A class used to represent and manipulate futures market data for cryptocurrencies.

    This class inherits from `CryptoMarketData` and provides methods for fetching,
    storing, and managing futures data for specified cryptocurrencies (BTC or ETH)
    over a given date range.

    Attributes
    ----------
    __type : str
        The type of market data (futures), used internally for fetching the data. (class attribute)
    __currency : Literal["BTC", "ETH"]
        The cryptocurrency symbol (BTC or ETH) for which futures data is to be fetched.
    __start : str
        The start date of the historical data.
    __end : str
        The end date of the historical data.
    __historical_data : pd.DataFrame
        The DataFrame containing the historical futures data for the given cryptocurrency
        and date range.

    Methods
    -------
    type()
        Returns the type of market data (futures).

    Properties
    ----------
    historical_data()
        Returns the fetched historical futures data as a DataFrame.
    currency()
        Gets or sets the cryptocurrency symbol for the futures data (BTC or ETH).
    start()
    ...
    def __init__(
        ...
        """
        Initializes the FuturesData object by fetching the historical futures data
        for the specified cryptocurrency and date range.

        Parameters
        ----------
        currency : Literal["BTC", "ETH"]
            The cryptocurrency symbol (BTC or ETH) for which to fetch the futures data.
        start : str
        ...
        # Fetch the historical futures data for the given parameters
    ...
    def type(cls):
        ...
        -------
        str
            The type of market data, which is "futures".
        """
        return cls.__type
    ...
    def historical_data(self):
        """
        Returns the historical futures data as a DataFrame.

        Returns
        -------
        pd.DataFrame
            The DataFrame containing the historical futures data.
        """
    ...
    def currency(self) -> Literal["BTC", "ETH"]:
        """
        Gets or sets the cryptocurrency symbol (BTC or ETH) for the futures data.
        ...
        -------
        Literal["BTC", "ETH"]
            The cryptocurrency symbol (BTC or ETH) for which the futures data is fetched.
    ...
    def start(self) -> str:
        """
        Gets or sets the start date for the historical futures data.
    ...
    def end(self) -> str:
        """
        Gets or sets the end date for the historical futures data.
